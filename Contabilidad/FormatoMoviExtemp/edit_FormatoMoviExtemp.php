...
<body>
            ...
            <div class="container-fluid" style="margin-top: 50px; background-color: rgb(255, 255, 255); padding: 1rem; border-radius: 8px; box-shadow: 0px 0px 8px rgba(0, 0, 0, 0.634);">
                <div class="row">
                    <div class="col col-sm-12" style="display: flex;">
                        <div>
                            <p>Contabilidad/Formato Movimiento Extemporaneos/Editar</p>
                    ...
                    <div class="col col-sm-12">
                        <div class="row">
                            <div class="col col-sm-12 table-responsive">
                                <div>
                                    <h2 style="text-align: center;">Editar Formato Movimiento Extemporaneos</h2>
                                    <small>Campos de caracter obligatorio(*). De no contar con la informacion poner en el campo <b>N/A</b></small>
                                </div>

                                <div>
                                    <form action="../FormatoMoviExtemp/back/update_FormatoMoviExtemp.php" method="post" id="mi_formulario">
                                        <div class="row">
                                            <div class="col col-sm-4">
                                                <div class="mb-3">
                                                    <label for="num_ope" class="form-label">N° Operación(*)</label>
                                                    <input type="hidden" class="form-control" id="id_ext" name="id_ext"  required>
    ...
    <script async src="../../static/js/Contabilidad//cont_mov_ext_edit.js"></script>
    <!-- Popper.JS -->

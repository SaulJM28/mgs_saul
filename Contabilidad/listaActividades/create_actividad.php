...
<body>
            ...
            <div class="container-fluid" style="margin-top: 50px; background-color: rgb(255, 255, 255); padding: 1rem; border-radius: 8px; box-shadow: 0px 0px 8px rgba(0, 0, 0, 0.634);">
                <div class="row">
                    <div class="col col-sm-12" style="display: flex;">
                        <div>
                            <p>Contabilidad/Lista de Actividades/create_actividad</p>
                    ...
                    <div class="col col-sm-12">
                        <div class="row">
                            <div class="col col-sm-12 table-responsive">
                                ...
                                <div>
                                    <form action="./back/insert_actividad.php" method="post" id="mi_formulario" enctype="multipart/form-data">
                                        <div class="row">
    ...
    <script async src="../../static/js/Contabilidad/cont_list_actividades_create.js"></script>
    <!-- Popper.JS -->

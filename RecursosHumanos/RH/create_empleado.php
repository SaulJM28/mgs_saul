            ...
            <div class="container-fluid" style="margin-top: 50px; background-color: rgb(255, 255, 255); padding: 1rem; border-radius: 8px; box-shadow: 0px 0px 8px rgba(0, 0, 0, 0.634);">
                ...
                <div class="row">
                    <div class="col col-sm-12">
                        ...
                        <div class="row">
                            <div class="col col-sm-12">
                                <form method="POST" action="./back/insert_empleado.php" id="mi_formulario" enctype="multipart/form-data">
                                    ...
                                    <div class="row g-4">
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control form-control-sm" id="CURP" name="CURP" placeholder="Ingrese el CURP" onChange="validar_curp()" minlength="18" maxlength="18" required>
                                        ...
                                        <h5 style="text-align: center;">Subir Documentos</h5>
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                <label for="acta_nac" class="form-label">Acta de Nacimiento</label>
                                                <input class="form-control form-control-sm" id="acta_nac" name="acta_nac" type="file">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                <label for="doc_rfc" class="form-label">RFC</label>
                                                <input class="form-control form-control-sm" id="doc_rfc" name="doc_rfc" type="file">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                <label for="datos_bancarios" class="form-label">Datos Bancarios</label>
                                                <input class="form-control form-control-sm" id="datos_bancarios" name="datos_bancarios" type="file">
                                            </div>
                                        </div>

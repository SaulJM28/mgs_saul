    ...
    <div class="wrapper">
        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled components">
                <li>
                    <a href="#Dashboard" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">Areas</a>
                    <ul class="collapse list-unstyled" id="Dashboard">
                        <li>
                            <a href="#">Registra Nueva Área</a>
                        </li>
                    </ul>
            ...
            <div class="container-fluid" style="margin-top: 50px; background-color: rgb(255, 255, 255); padding: 1rem; border-radius: 8px; box-shadow: 0px 0px 8px rgba(0, 0, 0, 0.634);">
                <div class="row">
                    <div class="col col-sm-12" style="display: flex;">
                        <div>
                            <p>Recursos Humanos/Áreas/Lista de Áreas</p>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col col-sm-12">
                        ...
                        <div class="row">
                            <div class="col-md-12 table-responsive">
                                <table class="table table-hover table-bordered table-sm estilo_tabla" style="width:100%" id="tablaListaAreas">
                                    <thead>
                                        <tr>
                                            <th>Nombre Área</th>
                                            <th>Estatus</th>
                                    ...
                                    <tbody>
                                        ...
                                        $consulta = "SELECT * FROM puestos_rh WHERE estatus = 'ACTIVO';";
                                        $datos = mysqli_query($enlace, $consulta);
                                        while ($dato = mysqli_fetch_assoc($datos)) {
                                        ?>
                                            <tr>
                                                <td><?php echo $dato['nom_puesto']; ?></td>
                                                ...
                                                <td style="display: flex; justify-content: center;   align-items: center;">
                                                    <div class="btn-group" role="group">
                                                        ...
                                                        <ul class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                                            <li><a type="button" class="dropdown-item"  data-bs-toggle="modal" data-bs-target="#editar" title="Editar :  <?php echo $dato['nom_puesto']; ?>" onclick="get_datos_edit('<?php echo $dato['id_puesto']; ?>')"><i class="fa fa-edit"></i> Editar</a></li>
                                                            <li><a type="button" class="dropdown-item"  data-bs-toggle="modal" data-bs-target="#eliminar" title="Eliminar:  <?php echo utf8_encode($dato['nom_puesto']); ?>" onclick="get_datos_elim('<?php echo $dato['id_puesto']; ?>')"><i class="fa-solid fa-trash"></i> Eliminar</a></li>
                                                        </ul>
                                                    </div>
                                                </td>
                                            </tr>
    ...
    <div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="../Areas/back/insert_area.php" method="POST" enctype="multipart/form-data">
                        <div class="alert alert-warning alert-dismissible fade show" role="alert">
                            <strong>!Aviso!</strong> Campos de caracter obligatorio <strong>(*)</strong>.
                            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                        </div>
                        <div class="mb-3">
                            <label for="nom_area" class="form-label">Nombre Áreas (*)</label>
                            <input type="text" class="form-control form-control-sm" style="text-transform: uppercase;" maxlength="150" minlength="1" onkeyup="javascript:this.value=this.value.toUpperCase();" id="nom_area" name = "nom_area" placeholder="Ingrese el nombre de la área a registrar" required>
                        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="../Areas/back/update_area.php" method="POST" enctype="multipart/form-data">
                        <div class="alert alert-warning alert-dismissible fade show" role="alert">
                            <strong>!Aviso!</strong> Campos de caracter obligatorio <strong>(*)</strong>.
                            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                        </div>
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control form-control-sm" style="text-transform: uppercase;" maxlength="150" minlength="1" onkeyup="javascript:this.value=this.value.toUpperCase();" id="nom_area_edit" name="nom_area_edit" placeholder="Ingrese el nombre de la área a registrar" required>
                        </div>
                        <div style="display: flex; justify-content: right">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header bg-danger text-white">
                    <h5 class="modal-title" id="staticBackdropLabel">Eliminar Área</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form action="../Areas/back/delete_area.php" method="POST" enctype="multipart/form-data">
                        <h5>¿Desea eliminar?</h5>
                        <div class="mb-3">
                            <label for="nom_area" class="form-label">Nombre Áreas</label>
                            <input type="hidden"  id="id_elim" name="id_elim" >
                            <input type="text" class="form-control form-control-sm" style="text-transform: uppercase;" maxlength="150" minlength="1" onkeyup="javascript:this.value=this.value.toUpperCase();" id="nom_area_elim"  name="nom_area_elim" placeholder="Ingrese el nombre de la área a registrar"  readonly required>
                        </div>
                        <div style="display: flex; justify-content: right">
...
<script async src="../../static/js/RecursosHumano/area_lista_areas.js"></script>
<!-- Popper.JS -->

            ...
            <div class="container-fluid" style="margin-top: 50px; background-color: rgb(255, 255, 255); padding: 1rem; border-radius: 8px; box-shadow: 0px 0px 8px rgba(0, 0, 0, 0.634);">
                <div class="row">
                    <div class="col col-sm-12" style="display: flex;">
                        <div>
                            <p>Recursos Humanos/R H/Crear Empleado</p>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col col-sm-12">
                        <div class="row">
                            <div class="col col-sm-12">
                                <div>
                                    <a href="../ExpedienteClinico/create_peso_talla.php" class="btn  btn-primary btn-sm"><i class="fa-solid fa-arrow-left"></i> Volver</a>
                                </div>
                                <div>
                        ...
                        <div class="row">
                            <div class="col col-sm-12">
                                <form method="POST" action="../RH/back/insert_empleado.php" id="mi_formulario" enctype="multipart/form-data">
                                    <h5 style="text-align: center;">Datos personales del empleado</h5>
                                    <div class="row g-4">
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                        ...
                                        <!-- <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control form-control-sm" id="nss" name="nss" placeholder="Ingrese el numero de seguro social" maxlength="11" readonly>
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control form-control-sm" id="CURP" name="CURP" placeholder="Ingrese el CURP"  onChange="validar_curp()"  validar maxlength="18" required>
                                        ...
                                        <!-- <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control form-control-sm" id="RFC" name="RFC" placeholder="Ingrese el RFC" maxlength="13" readonly>
                                        ...
                                        <!-- <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control form-control-sm" id="tel" name="tel" placeholder="Ingrese el teléfono celular" maxlength="12" readonly>
                                                <small class="form-text"></small>
                                            </div>
                                        </div> -->
                                        ...
                                        <!-- <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <input type="email" class="form-control form-control-sm" id="correo_emp" name="correo_emp" placeholder="Ingrese el correo electronico" readonly>
                                                <small class="form-text"></small>
                                            </div>
                                        </div> -->
                                        ...
                                        <!-- <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select form-select-sm" id="gra_aca" name="gra_aca" readonly>
                                        ...
                                        <!-- <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control form-control-sm" id="nom_carr" name="nom_carr" placeholder="Ingrese el nombre de la carrera" readonly>
                                        ...
                                        <!-- <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select form-select-sm" id="est_civ" name="est_civ" readonly>
                                        ...
                                        <!-- <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select form-select-sm" id="hijos" name="hijos" onchange="numhijos()" readonly>
                                        ...
                                        <!-- <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control form-control-sm" id="num_conct_emerg" name="num_conct_emerg" placeholder="Ingrese el número de hijos" maxlength="12" readonly>
                                                <small class="form-text"></small>
                                            </div>
                                        </div> -->
                                        ...
                                        <!-- <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <input type="number" step="any" class="form-control form-control-sm" id="sueldo" name="sueldo" placeholder="Ingrese el sueldo" readonly>
                                                <small class="form-text"></small>
                                            </div>
                                        </div> -->

...
<body>
                    ...
                    <div class="col col-sm-12">
                        <div class="row">
                            <div class="col col-sm-12">
                                ...
                                <a href="../ExpedienteClinico/create_empleado.php" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Crear empleado</a>
                                <div>
                                    <h2 style="text-align: center;">Registro Peso Talla</h2>
                                ...
                                <form action="./back/insert_peso_talla.php" method="post" enctype="multipart/form-data">
                                    <div class="row">
    ...
    <script async src="../../static/js/RecursosHumano/peso_talla_create.js"></script>
    <!-- Popper.JS -->

    ...
    <div class="wrapper">
        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled components">
                <li>
                    <a href="#Dashboard" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">Ubicaciones</a>
                    <ul class="collapse list-unstyled" id="Dashboard">
                        <li>
                            <a href="../Empresas/lista_empresas.php">Lista de Ubicaciones</a>
                        </li>
                    </ul>
            ...
            <div class="container-fluid" style="margin-top: 50px; background-color: rgb(255, 255, 255); padding: 1rem; border-radius: 8px; box-shadow: 0px 0px 8px rgba(0, 0, 0, 0.634);">
                <div class="row">
                    <div class="col col-sm-12" style="display: flex;">
                        <div>
                            <p>Recursos Humanos/Ubicaciones/Lista de Ubicaciones</p>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col col-sm-12">
                        <h2 style="text-align: center;">Lista de Ubicaciones</h2>
                        ...
                        <div class="row">
                            <div class="col-md-12 table-responsive">
                                <table class="table table-hover table-bordered table-sm estilo_tabla" style="width:100%" id="tablaListaUbicaciones">
                                    <thead>
                                        <tr>
                                                ...
                                                <td style="display: flex; justify-content: center;   align-items: center;">
                                                    <div class="btn-group" role="group">
                                                        ...
                                                        <ul class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                                            <li><a type="button" class="dropdown-item"  data-bs-toggle="modal" data-bs-target="#editar" title="Editar :  <?php echo $dato['nom_ubic']; ?>" onclick="get_datos_edit('<?php echo $dato['id_ubic']; ?>')"><i class="fa fa-edit"></i> Editar</a></li>
                                                            <li><a type="button" class="dropdown-item"  data-bs-toggle="modal" data-bs-target="#eliminar" title="Eliminar:  <?php echo utf8_encode($dato['nom_ubic']); ?>" onclick="get_datos_elim('<?php echo $dato['id_ubic']; ?>')"><i class="fa-solid fa-trash"></i> Eliminar</a></li>
                                                        </ul>
                                                    </div>
                                                </td>
                                            </tr>
    ...
    <div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="../Ubicaciones/back/insert_ubicacion.php" method="POST" enctype="multipart/form-data">
                        <div class="alert alert-warning alert-dismissible fade show" role="alert">
                            <strong>!Aviso!</strong> Campos de caracter obligatorio <strong>(*)</strong>.
                            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                        </div>
                        <div class="mb-3">
                            <label for="nom_ubic" class="form-label">Nombre Ubicación (*)</label>
                            <input type="text" class="form-control form-control-sm" style="text-transform: uppercase;" maxlength="150" minlength="1" onkeyup="javascript:this.value=this.value.toUpperCase();" id="nom_ubic" name = "nom_ubic" placeholder="Ingrese el nombre de la ubicación a registrar" required>
                        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="../Ubicaciones/back/update_ubicacion.php" method="POST" enctype="multipart/form-data">
                        <div class="alert alert-warning alert-dismissible fade show" role="alert">
                            <strong>!Aviso!</strong> Campos de caracter obligatorio <strong>(*)</strong>.
                            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                        </div>
                        <div class="mb-3">
                            <label for="nom_ubic_edit" class="form-label">Nombre Ubicación (*)</label>
                            <input type="hidden"  id="id_edit" name='id_edit'>
                            <input type="text" class="form-control form-control-sm" style="text-transform: uppercase;" maxlength="150" minlength="1" onkeyup="javascript:this.value=this.value.toUpperCase();" id="nom_ubic_edit" name="nom_ubic_edit" placeholder="Ingrese el nombre de la Ubicacion a editar" required>
                        </div>
                        <div style="display: flex; justify-content: right">
    ...
    <div class="modal fade" id="eliminar" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="../Ubicaciones/back/delete_ubicacion.php" method="POST" enctype="multipart/form-data">
                    <div class="alert alert-warning alert-dismissible fade show" role="alert">
                        ...
                        <div class="mb-3">
                            <label for="nom_emp_elim" class="form-label">Nombre Ubicación</label>
                            <input type="hidden"  id="id_elim" name="id_elim" >
                            <input type="text" class="form-control form-control-sm" style="text-transform: uppercase;" maxlength="150" minlength="1" onkeyup="javascript:this.value=this.value.toUpperCase();" id="nom_ubic_elim"  name="nom_ubic_elim" placeholder="Nombre de la Ubicación a eliminar"  readonly required>
                        </div>
                        <div style="display: flex; justify-content: right">
...
<script async src="../../static/js/RecursosHumano/ubicacion_lista_ubicaciones.js"></script>
<!-- Popper.JS -->

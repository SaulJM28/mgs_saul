...
<body>
            ...
            <div class="container-fluid" style="margin-top: 50px; background-color: rgb(255, 255, 255); padding: 1rem; border-radius: 8px; box-shadow: 0px 0px 8px rgba(0, 0, 0, 0.634);">
                <div class="row">
                    <div class="col col-sm-12" style="display: flex;">
                        <div>
                            <p>Recursos Humanos/Salarios/Editar nuevo salario</p>
                        </div>
                    </div>
                </div>
                <div class="row">
                        ...
                        <div class="row">
                            <div class="col col-sm-12">
                                <div>
                                    ...
                                    <h2 style="text-align: center;">Editar aumento de salario a empleados</h2>
                                ...
                                <form action="./back/update_nuevo_salario.php" method="post" enctype="multipart/form-data">
                                    <div class="row">
                                        <div class="col-md-1"></div>
                                        <div class="col-md-5">
                                        <div class="mb-3">
                                        <label for="fech_regis" class="form-label">Empleado</label>
                                            <input type="hidden"  class="form-control form-control-sm" id="id" name="id"  readonly>
                                            <input type="hidden"  class="form-control form-control-sm" id="id_emp" name="id_emp"  readonly>
    ...
    <script async src="../../static/js/RecursosHumano/salarios_listaEmpleados_edit.js"></script>
    <!-- Popper.JS -->

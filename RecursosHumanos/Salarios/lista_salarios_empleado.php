...
<body>
            ...
            <div class="container-fluid" style="margin-top: 50px; background-color: rgb(255, 255, 255); padding: 1rem; border-radius: 8px; box-shadow: 0px 0px 8px rgba(0, 0, 0, 0.634);">
                <div class="row">
                    <div class="col col-sm-12" style="display: flex;">
                        <div>
                            <p>Recursos Humanos/Salarios/Lista de salarios por empleado</p>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col col-sm-12">
                        <div class="row">
                            <div class="col col-sm-12">
                                <div>
                                    <h2 style="text-align: center;">Salarios Empleado</h2>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-hovered table-bordered table-sm estilo_tabla" id="tableSalariosEmpleado">
                                        <thead>
                                            <tr>
                                                <th>Nombre</th>
    ...
    <script async src="../../static/js/RecursosHumano/salarios_listaEmpleado.js"></script>
    <!-- Popper.JS -->

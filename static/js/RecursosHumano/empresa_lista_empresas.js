$(document).ready(function () {
    ...
    var table = $("#tablaListaEmpresas").DataTable({
        paging: true,
        stateSave: true,
        scrollX: true,
        scrollY: true,
  ...
  function get_datos_edit(id) {
    $.ajax({
      type: "POST",
      url: "../Empresas/back/get_empresaById.php",
      data: {
        id_empresa: id,
      },
      async: true,
      ...
      success: function (response) {
        if (response != "noData") {
          let data = JSON.parse(response);
              ...
              document.getElementById("id_edit").value = data.id_empresa;
              document.getElementById("nom_emp_edit").value = data.nom_emp;
      ...
      success: function (response) {
        if (response != "noData") {
          let data = JSON.parse(response);
              ...
              document.getElementById("id_elim").value = data.id_empresa;
              document.getElementById("nom_emp_elim").value = data.nom_emp;

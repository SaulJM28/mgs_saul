$(document).ready(function () {
    ...
    $("#periodoFechas").html("Periodo del: " + fhf + "");

    $("#tableFletesTrans tfoot th").each(function () {
        var title = $(this).text();
        $(this).html(
      ...
      var table = $("#tableFletesTrans").DataTable({
        scrollX: true,
        scrollY: "525px",
...
/*   var table = $("#myTableFiltradaGracoil").DataTable(); */
  ...
  function filtrar_dato() {
    var ff = document.getElementById("fecha_filtro").value;

  
    
    if (ff == ""   ) {
      alert("Fecha filtro esta vacia");
    } else {
        $("#periodoFechas").html("");
        $("#peridoFechasFiltradas").html("Periodo del: " + ff + "");
    }

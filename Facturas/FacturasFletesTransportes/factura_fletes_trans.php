...
<html>
  ...
  <body>
        ...
        <div class="container-fluid" style="margin-top: 50px; background-color: rgb(255, 255, 255); padding: 1rem; border-radius: 8px; box-shadow: 0px 0px 8px rgba(0, 0, 0, 0.634);">
          <div class="row">
            <div class="col col-sm-12" style="display: flex;">
              <div><p>Facturación/Facturas de fletes transportes/ver</p></div>
            </div>
          </div>
          <div class="row">
            <div class="col col-sm-12">
              <div><h5>Fletes </h5></div>
              <div style="display: flex; justify-content: center">
                <form action="/action_page.php">
                  <div class="form-group" style="display: inline-block">
                    <label for="fecha_filtro" style="cursor: pointer;">Desde </label>
                  ...
                  <a type="button" class="btn btn-success btn-sm" href="../../Facturas/FacturasFletesTransportes/factura_fletes_trans.php"><i class="fa-solid fa-table-list"></i> Todos</a>
                </form>
              </div>
              <br>
              <div>
              ...
              <div class="row" id="mostrarDatos">
                <div class="col col-sm-12 table-responsive">
                  <table class="table table-hover table-bordered table-sm estilo_tabla" id="tableFletesTrans">
                    <thead>
                      <tr>
                        <th>Cliente</th>
                        <th>Factura</th>
                    ...
                    <tbody id="tableFletesTransDatos"></tbody>
                    <tfoot>
                      <tr>
                        <th></th>
                        <th></th>
    ...
    <script async src="../../static/js/Facturacion/fact_FFT_factura_flete.js"></script>
    <!-- Popper.JS -->

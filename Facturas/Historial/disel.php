...
<html>
  ...
  <body>
        ...
        <div class="container-fluid" style="margin-top: 50px; background-color: rgb(255, 255, 255); padding: 1rem; border-radius: 8px; box-shadow: 0px 0px 8px rgba(0, 0, 0, 0.634);">
          <div class="row">
            <div class="col col-sm-12" style="display: flex;">
              <div><p>Facturación/Historial/disel</p></div>
            </div>
          </div>
          <div class="row">
            <div class="col col-sm-12">
              <div><h5>Historial de Facturas Disel </h5></div>
              <div style="display: flex; justify-content: center">
                <form action="/action_page.php">
                  <div class="form-group" style="display: inline-block">
                  <select class="form-select" aria-label="Default select example" id="empresa_filtro">
                      <option value="">Selecione una empresa</option>
                      <option value="grac">Gracoil</option>
                      <option value="inter">Interamericana</option>
                      <!-- <option value="3">JMG</option> -->
                    </select>
              ...
              <div class="row" id="allDatosGracoil">
                <div class="col col-sm-12 table-responsive">
                  <table
                    class="table table-hover table-bordered table-sm estilo_tabla"
                    id="myTableGracoil"
                  >
                    <thead>
                      <tr>
    ...
    <script async src="../../static/js/Facturacion/fact_hist_disel.js"></script>
    <!-- Popper.JS -->

...
<body>
            ...
            <div class="container-fluid" style="margin-top: 50px; background-color: rgb(255, 255, 255); padding: 1rem; border-radius: 8px; box-shadow: 0px 0px 8px rgba(0, 0, 0, 0.634);">
                <div class="row">
                    <div class="col col-sm-12" style="display: flex;">
                        <div>
                            <p>Facturación/Factura cliente sin entrega/Ver</p>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col col-sm-12">
                        <div class="row">
                            <div class="col col-sm-12 table-responsive">
                                <div>
                                    <h2 style="text-align: center;">Reporte facturas cliente sin entrega</h2>
                                </div>
                                <table class="table table-hover table-bordered table-sm estilo_tabla" id="tableFacturasClieSinEntrega">
                                    <thead>
                                        <tr>
                                            <th>Empresa</th>
                                    ...
                                    <tbody id="tableFacturasClieSinEntregaDatos"></tbody>
                                    <tfoot>
                                        <tr>
                                            <th></th>
                                            <th></th>
    ...
    <script async src="../../static/js/Facturacion/fact_factura_cliente_sin_entrega.js"></script>
    <!-- Popper.JS -->

...
<body>
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="nav navbar-nav ml-auto">
                            ...
                            <li class="nav-item">
                                <a class="nav-link link-nav-top link-nav-top-active" href="./pedSinFactClienAlterno.php" style="color: white; margin: 0px 0px 0px 5px">Alterno</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link link-nav-top" href="./pedSinFactClienGasolina.php" style="color: white; margin: 0px 0px 0px 5px">Gasolina</a>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="container-fluid" style="margin-top: 50px; background-color: rgb(255, 255, 255); padding: 1rem; border-radius: 8px; box-shadow: 0px 0px 8px rgba(0, 0, 0, 0.634);">
                <div class="row">
                    <div class="col col-sm-12" style="display: flex;">
                        <div>
                            <p>Facturación/Pedido sin Factura cliente/Alterno</p>
                        </div>
                    </div>
                </div>
                <div class="row">
    ...
    <script async src="../../static/js/Facturacion/fact_psfc_alterno.js"></script>
    <!-- Popper.JS -->

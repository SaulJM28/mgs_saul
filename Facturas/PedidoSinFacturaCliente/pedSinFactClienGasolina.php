...
<body>
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="nav navbar-nav ml-auto">
                            ...
                            <li class="nav-item">
                                <a class="nav-link link-nav-top" href="./pedSinFactClienDisel.php" style="color: white; margin: 0px 0px 0px 5px">Disel</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link link-nav-top" href="./pedSinFactClienAlterno.php" style="color: white; margin: 0px 0px 0px 5px">Alterno</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link link-nav-top link-nav-top-active" href="./pedSinFactClienGasolina.php" style="color: white; margin: 0px 0px 0px 5px">Gasolina</a>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="container-fluid" style="margin-top: 50px; background-color: rgb(255, 255, 255); padding: 1rem; border-radius: 8px; box-shadow: 0px 0px 8px rgba(0, 0, 0, 0.634);">
                <div class="row">
                    <div class="col col-sm-12" style="display: flex;">
                        <div>
                            <p>Facturación/Pedido sin Factura cliente/Gasolina</p>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col col-sm-12">
                        <div class="row">
                            <div class="col col-sm-12 table-responsive">
                                <div>
                                    <h2 style="text-align: center;">Pedidos VS Facturas</h2>
                                </div>
                                <div>
                                    <h5 style="text-align: center;" id="rangoFechas"></h5>
                                </div>
                                <table class="table table-hover table-bordered table-sm estilo_tabla" id="tablePedidosFacturas">
                                    <thead>
                                        <tr>
                                            <th>CIA</th>
                                            <th>Planta</th>
                                            ...
                                            <th>Fecha Pedido</th>
                                            <th>Hr Pedido</th>
                                            <th>LTS Solicitado</th>
                                            <th>Factura</th>
                                            <th>Estatus</th>
                                        </tr>
                                    </thead>
                                    <tbody id="tablePedidosFacturasDatos"></tbody>
                                    <tfoot>
                                        <tr>
                                            <th></th>
                                            <th></th>
    ...
    <script async src="../../static/js/Facturacion/fact_psfc_gasolina.js"></script>
    <!-- Popper.JS -->

...
<body>
                    ...
                    <div class="col col-sm-12">
                        <div class="row">
                            <div class="col col-sm-12 table-responsive">
                                <div>
                                    <h2 style="text-align: center;">Crear cancelación de documentos</h2>
                                    <small>Campos de caracter obligatorio(*)</small>
                                </div>

                                <div>
                                    <form action="../CancelarDocumentos/back/insert_cancelacionDocumentos.php" method="post" id="mi_formulario">
                                        <div class="row">
                                            <div class="col col-sm-12">
    ...
    <script async src="../../static/js/Facturacion/fact_cancelar_doc_create.js"></script>
    <!-- Popper.JS -->

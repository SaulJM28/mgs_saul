...
<html>
  ...
  <body>
        ...
        <div class="container-fluid" style="margin-top: 50px; background-color: rgb(255, 255, 255); padding: 1rem; border-radius: 8px; box-shadow: 0px 0px 8px rgba(0, 0, 0, 0.634);">
          <div class="row">
            <div class="col col-sm-12" style="display: flex;">
              <div><p>Inventarios/Reporte de Tanques y Cuenta Litros/Reporte de Infraestructura</p></div>
            </div>
          </div>
          <div class="row">
            <div class="col col-sm-12">
              <div><h5>Reporte de Infraestructura </h5></div>
              <br>
                <button class="btn btn-sm btn-success" id="toggleGracoil">Gracoil</button>
                <button class="btn btn-sm btn-primary" id="toggleInter">Inter</button>
                <button class="btn btn-sm btn-warning text-white" id="toggleMapa"><i class="fa-solid fa-map-location"></i> Mapa</button>
              <br>
              <br>

              <div class="row" id="ReporteGracoil">
                <div class="col col-sm-12 table-responsive">
                  <table class="table table-hover table-bordered table-sm estilo_tabla" id="tableReporteGracoil">
                    <thead>
                      <tr>
                        <th>Sociedad</th>
                        <th>Codigo de Cliente</th>
                        <th>Nombre de Cliente</th>
                        <th>Nombre Asesor de Ventas</th>
                        <th>Compromiso de compra</th>
                        <th>Equipo de despacho</th>
                        <th>Tanque</th>
                        <th>Estatus de cliente</th>
                      </tr>
                    </thead>
                    <tbody id="tableReporteGracoilDatos"></tbody>
                    <tfoot>
                      <tr>
                        <th></th>
                        <th></th>
              ...
              <div class="row" id="ReporteInter" style="display: none;">
                <div class="col col-sm-12 table-responsive">
                  <table class="table table-hover table-bordered table-sm estilo_tabla" id="tableReporteInterDatos">
                  <thead>
                      <tr>
                        <th>Sociedad</th>
                        <th>Codigo de Cliente</th>
                    ...
                    <tbody id="tableReporteInterDatos"></tbody>
                    <tfoot>
                      <tr>
                        <th></th>
                        <th></th>
              ...
              <div class="row" id="ReporteMapa" style="display: none;">
                <div class="col col-sm-12 table-responsive"  id="map_div">
                </div>
              </div>
    ...
    <script async src="../../static/js/Inventarios/inv_rtl_reporte_infrac.js"></script>
    <!-- Popper.JS -->

...
<body>
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="nav navbar-nav ml-auto">
                            ...
                            <li class="nav-item">
                                <a class="nav-link link-nav-top " href="./disel.php" style="color: white; margin: 0px 0px 0px 5px">Disel</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link link-nav-top link-nav-top-active" href="./alterno.php" style="color: white; margin: 0px 0px 0px 5px">Alterno</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link link-nav-top" href="./gasolina.php" style="color: white; margin: 0px 0px 0px 5px">Gasolina</a>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="container-fluid" style="margin-top: 50px; background-color: rgb(255, 255, 255); padding: 1rem; border-radius: 8px; box-shadow: 0px 0px 8px rgba(0, 0, 0, 0.634);">
                <div class="row">
                    <div class="col col-sm-12" style="display: flex;">
                        <div>
                            <p>Inventario/Cruce de Entrada VS Factura Proveedor/Cruce de Entrada VS Factura Proveedor</p>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col col-sm-12">
                        <div>
                            <h5>Entrada VS Factura Proveedor cruce de entradas</h5>
                        </div>
                        <div style="display: flex; justify-content: center">
                            <form action="/action_page.php">
                                ...
                                <a type="button" class="btn btn-success btn-sm" href="../../Facturas/Historial/disel.php"><i class="fa-solid fa-table-list"></i> Todos</a>
                            </form>
                        </div>
                        <br>
                        <div>
                            <h5 style="text-align: center" id="periodoFechasGracoil"></h5>
                        </div>
                        <div>
                            <h5 style="text-align: center" id="datosfiltro"></h5>
                        </div>
                        <br>
                        <div class="row" id="allDatosGracoil">
                            <div class="col col-sm-12 table-responsive">
                                <table class="table table-hover table-bordered table-sm estilo_tabla" id="myTableEFPF">
                                    <thead>
                                        <tr>
                                            <th>CIA</th>
                                            <th>C.Proveedor</th>
                        ...
                        <div class="row" style="display: none" id="filterDatosEFPF">
                            <div class="col col-sm-12">
                                <table class="table table-hover table-bordered table-sm estilo_tabla" id="myTableFiltradaEFPF">
                                    <thead>
                                        <tr>
                                    ...
                                    <tbody id="datosTablaEFPFFiltrados"></tbody>
                                    <tfoot>
                                        <tr>
                                            <th></th>
                                            <th></th>
    ...
    <script async src="../../static/js/Inventarios/inv_efpf_ent_fact_prove.js"></script>
    <!-- Popper.JS -->

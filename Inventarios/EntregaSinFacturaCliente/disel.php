...
<body>
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="nav navbar-nav ml-auto">
                            ...
                            <li class="nav-item">
                                <a class="nav-link link-nav-top link-nav-top-active" href="./disel.php" style="color: white; margin: 0px 0px 0px 5px">Disel</a>
                            </li>
                            <li class="nav-item">
            ...
            <div class="container-fluid" style="margin-top: 50px; background-color: rgb(255, 255, 255); padding: 1rem; border-radius: 8px; box-shadow: 0px 0px 8px rgba(0, 0, 0, 0.634);">
                <div class="row">
                    <div class="col col-sm-12" style="display: flex;">
                        <div>
                            <p>Inventario/Entrega sin Factura Cliente/disel</p>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col col-sm-12">
                        <div>
                            <h5>Entrega VS Factura Cliente Diesel</h5>
                        </div>
    ...
    <script async src="../../static/js/Inventarios/inv_esfc_disel.js"></script>
    <!-- Popper.JS -->

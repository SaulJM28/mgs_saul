...
<body>
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="nav navbar-nav ml-auto">
                            ...
                            <li class="nav-item">
                                <a class="nav-link link-nav-top " href="./alterno.php" style="color: white; margin: 0px 0px 0px 5px">Alterno</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link link-nav-top link-nav-top-active" href="./gasolina.php" style="color: white; margin: 0px 0px 0px 5px">Gasolina</a>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="container-fluid" style="margin-top: 50px; background-color: rgb(255, 255, 255); padding: 1rem; border-radius: 8px; box-shadow: 0px 0px 8px rgba(0, 0, 0, 0.634);">
                <div class="row">
                    <div class="col col-sm-12" style="display: flex;">
                        <div>
                            <p>Inventario/Entrega sin Factura Cliente/gasolina</p>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col col-sm-12">
                        <div>
                            <h5>Entrega VS Factura Cliente Gasolina</h5>
                        </div>
                        ...
                        <div class="row" id="allDatosGracoil">
                            <div class="col col-sm-12 table-responsive">
                                <table class="table table-hover table-bordered table-sm estilo_tabla" id="myTableGracoil">
                                    <thead>
                                        <tr>
                                            <th>CIA</th>
                                            <th>Planta</th>
                                    ...
                                    <tbody id="datosTablaGracoil"></tbody>
                                    <tfoot>
                                        <tr>
                                            <th></th>
                                            <th></th>
                        ...
                        <div class="row" style="display: none" id="filterDatosGracoil">
                            <div class="col col-sm-12">
                                <table class="table table-hover table-bordered table-sm estilo_tabla" id="myTableFiltradaGracoil">
                                    <thead>
                                        <tr>
                                    ...
                                    <tbody id="datosTablaGracoilFiltrados"></tbody>
                                    <tfoot>
                                        <tr>
                                            <th></th>
                                            <th></th>
    ...
    <script async src="../../static/js/Inventarios/inv_esfc_gasolina.js"></script>
    <!-- Popper.JS -->

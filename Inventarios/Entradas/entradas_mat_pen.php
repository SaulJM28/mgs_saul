...
<body>
            ...
            <div class="container-fluid" style="margin-top: 50px; background-color: rgb(255, 255, 255); padding: 1rem; border-radius: 8px; box-shadow: 0px 0px 8px rgba(0, 0, 0, 0.634);">
                <div class="row">
                    <div class="col col-sm-12" style="display: flex;">
                        <div>
                            <p>Inventarios/Entradas/Entradas de material pendientes</p>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col col-sm-12">
                        <div>
                            <h5>Entradas de material pendientes</h5>
                        </div>
                        <br>
                        ...
                        <button class="btn btn-sm btn-warning" id="toggleSGS">SGS</button>
                        <br>
                        <br>
    ...
    <script async src="../../static/js/Inventarios/inv_ent_materialPend.js"></script>
    <!-- Popper.JS -->
